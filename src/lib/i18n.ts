...
const logoEn = {
  ...
  'logo.exportComplete': 'Every video in the Batch is ready in temporary browser storage.',
...
const logoRu: LogoMessages = {
  ...
  'logo.exportComplete': 'Все видео Пакета готовы во временном хранилище браузера.',
