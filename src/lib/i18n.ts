...
const bn: Messages = localisedCatalog({
...
const ru: Messages = localisedCatalog({
...
const ja: Messages = localisedCatalog({
...
const fr: Messages = localisedCatalog({
...
const de: Messages = localisedCatalog({
...
const id: Messages = localisedCatalog({
...
const tr: Messages = localisedCatalog({
...
const ur: Messages = localisedCatalog({
...
const pl: Messages = localisedCatalog({
...
function localisedCatalog(c: CompactCatalog): Messages {
  return {
...
const catalogs: Record<Locale, Messages> = { en, es, zh, hi, ar, pt, bn, ru, ja, fr, de, id, tr, ur, pl };
